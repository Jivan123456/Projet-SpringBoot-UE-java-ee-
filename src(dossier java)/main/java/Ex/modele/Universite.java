...
public class Universite {
    ...
    // Relation OneToMany avec Campus (localisation géographique)
    ...
    // Relation OneToMany avec Composantes (hiérarchie administrative)
    // Une université possède plusieurs composantes (UFR, Écoles, IUT)
    // PAS de cascade REMOVE : une composante est une entité administrative
    // qui peut exister indépendamment de l'université (réorganisation, fusion, etc.)
